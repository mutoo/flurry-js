...
`;
  ...
  class Star {
    ...
    initBuffers(gl) {
      ...
      for (let k = 0; k < spikes; k++) {
        ...
        const p0 = fromValues(-3.0, 0, 0);
        const p1 = fromValues(0, size, 0);
        const p2 = fromValues(3.0, 0, 0);
        const rotMat = create$1();
        const a = (Math.random() * 360 * Math.PI) / 180;
        fromRotation(rotMat, a, [0, 0, 1]);
        const rP0 = fromValues(0, 0, 0);
        const rP1 = fromValues(0, 0, 0);
        const rP2 = fromValues(0, 0, 0);
    ...
    update(dt, timeElapsed) {
      ...
      const rotZ0 = fromZRotation(create$1(), rotation0);
      const rotY0 = fromYRotation(create$1(), rotation0);
      const rotX0 = fromXRotation(create$1(), rotation0);
      const rotZ1 = fromZRotation(create$1(), rotation1);
      const rotAll = create$1();
      multiply(rotAll, rotZ0, rotY0);
      multiply(rotAll, rotAll, rotX0);
      multiply(rotAll, rotAll, rotZ1);
      const v0 = fromValues(x0, y0, z0);
  ...
  class Spark {
    ...
    update(dt, timeElapsed) {
      ...
      multiply(rotAll, rotAll, rotX0);
      multiply(rotAll, rotAll, rotZ1);
      const tmpV0 = fromValues(x0, y0, z0);
